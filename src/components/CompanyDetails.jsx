...
<Nav/>
  ...
  <div className='bg-[#f7f7f7] h-full w-full'>
    ...
    <div className='flex flex-col justify-center items-center'>
        ...
        <div className='grid pb-12 w-[91%] grid-cols-3 gap-6 max-sm:grid-cols-1'>
            <div className='mt-6 col-span-2 bg-white h-[100vh] rounded-lg max-sm:h-[50vh]'>
                <h1 className='pt-6 pr-6 font-extrabold text-[#6e68c4] text-[1.1rem]'>قائمة المتقدمين</h1>
                <br />
                <hr className='flex justify-center w-full' />
  <div className='flex justify-center bg-[#ffffff] w-[93%] mt-4 '>
  <div role="tablist" className="tabs w-[90vw] tabs-lifted bg-white max-sm:w-[80vw] mr-14 max-sm:mr-0">
  <input type="radio" name="my_tabs_2" role="tab" className="tab bg-white hover:text-[#5C59C2] " aria-label="المتقدمون" defaultChecked/>

  <div role="tabpanel" className="tab-content w-full bg-white border-base-100 rounded-box p-6">
  ...
  <table className="w-full text-md bg-white shadow-md rounded mb-4  max-sm:text-xs max-sm:table-xs">
        <tbody>
          <tr className="focus:outline-none h-16 border border-[#e4e6e6] bg-[#fafafa] rounded">
            ...
            <th className="text-right p-3 px-5 max-sm:p-1">الايميل </th>
        ...
        <tr className="focus:outline-none h-16 border border-[#e4e6e6] rounded">
            ...
            <td className="p-3 px-5 max-sm:p-1">
                <div className="flex flex-wrap">
                    <p className="text-base font-medium max-sm:text-xs leading-none text-gray-700 w-[10ch] break-words max-sm:w-[10ch]">   نوره محمد  </p>
                </div>
            </td>
            <td className="p-3 px-5 max-sm:p-1">
                <div className="flex flex-wrap">
                    <p className="text-base font-medium max-sm:text-xs leading-none text-gray-700 w-[10ch] break-words max-sm:w-[10ch]">   معسكر جافاسكربت  </p>
                </div>
            </td>
            <td className="p-3 px-5 max-sm:p-1">
                <div className="flex flex-wrap">
                    <p className="text-base font-medium max-sm:text-xs leading-none text-gray-700 w-[10ch] break-words max-sm:w-[10ch]"> Nora@hotmail.com</p>
                </div>
            </td>
            <td className="p-3 px-5 max-sm:p-1">
                <div className="flex flex-wrap">
                    <p className="text-base font-medium max-sm:text-xs leading-none text-gray-700 w-[ch] break-words max-sm:w-[6ch]"> انتظار</p>
                </div>
            </td> 
            ...
            <td className="p-3 px-5 max-sm:p-1">
                <div className="flex justify-center items-center pl-5">
                    ...
                    <dialog id="my_modal_4" className="modal ">
                      <div className="modal-box w-[35vw] max-w-5xl max-sm:w-[70vw]">
                        <p className="py-4 text-[1.1rem] max-sm:text-center">هل انت متأكد من الغاء الطالب؟</p>
                        <div className="modal-action">
                          <form method="dialog" className='gap-6'>
                            <button className="btn ml-1 bg-[#99D2CB] text-white max-sm:w-[15vw]" >نعم</button>
                            <button className="btn bg-[#99D2CB] text-white max-sm:w-[15vw]">لا</button>
                          </form>
                        </div>
                      </div>
                    </dialog>
  ...
  <input type="radio" name="my_tabs_2" role="tab" className="tab bg-white hover:text-[#5C59C2]" aria-label="مكتمل" />
