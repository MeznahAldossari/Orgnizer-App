...
<div className='flex flex-col w-full bg-[#ffffff] border-t-none'>
    <div className='flex'>
      ...
      <>
       <Link to='/AddEvents'>
       <button className=' gap-3 px-3 w-[10vw] py-3 mt-16 max-sm:mt-0 text-white rounded-lg mr-12 font-bold text-[1rem] bg-[#f39e4e] flex '> 
       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 mt-0.5 mr-0 ">
        ...
        {getLocal.role === "admin" && Array.isArray(adminCard) ? (
            adminCard.map((item, index) => (
                <div key={index} className='rounded-lg h-[67vh] w-[23vw] border-2 shadow-lg bg-white max-sm:w-[90vw] max-sm:h-[50vh]'>
                    ...
                    <div className="p-4">
                        <h3 className="text-[1.5rem] font-semibold mb-2 text-[#4e4e4e]">{item.eventName}</h3>
                        <div className="flex flex-col justify-start items-start gap-3 pt-2">
                            <div className="flex items-center text-gray-500 font-semibold gap-2">
                                <svg className="w-6 h-6 mr-1 text-[#5C59C2]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm10 5H4v10h12V7z" clipRule="evenodd"></path></svg>
                                <span className='text-[0.8rem]'>{item.startDate} الى {item.endDate}</span>
                            </div>
                            <div className="flex items-center text-gray-500 text-sm font-semibold gap-2 ">
                                <svg className="w-6 h-6 mr-1 text-[#5C59C2]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 2a8 8 0 100 16 8 8 0 000-16zM8.5 7a.5.5 0 01.5-.5h2a.5.5 0 01.5.5V10a.5.5 0 01-.146.354l-2 2a.5.5 0 11-.708-.708L9.793 10H9V7.5a.5.5 0 01-.5-.5z" clipRule="evenodd"></path></svg>
                                <span className='text-[1rem]'>{item.startTime} - {item.endTime}</span>
                            </div>
                        </div>
                    ...
                    companyCard.map((item, index) => (
                        <div key={index} className='rounded-lg h-[67vh] w-[23vw] border-2 shadow-lg bg-white max-sm:w-[90vw] max-sm:h-[50vh]'>
                            ...
                            < div className="flex flex-col justify-start items-start gap-3 pt-2">
                                <div className="flex items-center text-gray-500 font-semibold gap-2">
                                    <svg className="w-6 h-6 mr-1 text-[#5C59C2]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm10 5H4v10h12V7z" clipRule="evenodd"></path></svg>
                                    <span className='text-[1rem]'>{item.startDate} الى {item.endDate}</span>
                                </div>
                                <div className="flex items-center text-gray-500 text-sm font-semibold gap-2 ">
                                    <svg className="w-6 h-6 mr-1 text-[#5C59C2]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10 2a8 8 0 100 16 8 8 0 000-16zM8.5 7a.5.5 0 01.5-.5h2a.5.5 0 01.5.5V10a.5.5 0 01-.146.354l-2 2a.5.5 0 11-.708-.708L9.793 10H9V7.5a.5.5 0 01-.5-.5z" clipRule="evenodd"></path></svg>
                                    <span className='text-[1rem]'>{item.startTime} - {item.endTime}</span>
            ...
            {studentCategory !== undefined && (
                    studentCategory.map((item, index) => (
                        <div key={index} className='rounded-lg mt-24 h-[67vh] w-[23vw] border-2 shadow-lg bg-white max-sm:w-[90vw] max-sm:h-[50vh]'>
                            <img src={item.imageUrl} className='max-sm:h-[28vh] w-[100%] h-[33vh] rounded-t-md' />
                            <div className="p-4">
                            <h3 className="text-[1.5rem] font-semibold mb-2 text-[#4e4e4e]">{item.eventName}</h3>
                            <div className="flex flex-col justify-start items-start gap-3 pt-2">
