  ...
  return (
    ...
    <GoogleMap
          ...
          <div className="flex justify-end mt-6 gap-2">
            ...
            <button type="submit"className="px-6 py-2 w-24 leading-5 text-white bg-[#f39e4e] hover:bg-[#ffb36c] rounded-md shadow-md " onClick={()=>document.getElementById('my_modal_5').showModal()}>اضافة</button>
