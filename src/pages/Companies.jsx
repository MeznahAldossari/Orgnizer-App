...
<div className='bg-white w-full h-full rounded-lg'>
    <div className='flex justify-start items-end w-full h-[10vh]'>
            <p className='font-semibold text-[1.5rem] mr-16 pt-1 pr-1 text-[#5C59C2] mb-7'> قائمة الشركات ذات الاهتمام بمجال تخصصك </p>
    ...
    <div className="w-fit mx-auto grid grid-cols-3 lg:grid-cols-3 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-32 mb-16 mt-10">
        {/* card here */}
        <div className='flex flex-col items-center mt-6 bg-white w-full h-[45vh] rounded-lg shadow'>
            <img className='mr-4 rounded-lg h-[20vh] w-[8vw]' src={Elm} />
            <div className='mr-4 flex flex-col gap-2'>
                <div className='flex justify-center gap-2'>
                    <p className='font-bold text-[1.3rem] pt-2 '>  شركة علم </p>
                </div>
