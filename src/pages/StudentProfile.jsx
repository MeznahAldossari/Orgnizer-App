    ...
    <div className='bg-[#f3f3f3] h-full w-full'>
        ...
        <div className='flex flex-col justify-center items-center'>
            <div className='flex items-center mt-6 bg-white w-[91%] h-[20vh] rounded-lg'>
                <img className='mr-4 rounded-full h-[15vh] w-[7vw]' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQA2aIMpOIYZKSLNRQnDOXtna8n7eRumIbYfA&s' />
                <div className='mr-4'>
            ...
            <div className='grid grid-cols-2 gap-6'>
                <div className='mt-6 bg-white w-[44vw] h-full rounded-lg'>
                ...
                <div className='flex justify-between w-[30vw] mt-4'>
                    <div className='flex flex-col'>
                        ...
                        <div className="mr-6 mt-2 relative w-64">
                            <select className="block appearance-none w-[31vw] h-[7vh] bg-white border border-[#99D2CB] hover:border-[#61b8ae] px-4 py-1 pr-8 rounded-full shadow leading-tight focus:outline-none focus:shadow-outline">
                ...
                <div className='flex justify-between w-[30vw] mt-4'>
                    <div className='flex flex-col'>
                        ...
                        <div className="mr-6 mt-2 relative w-64">
                            <select className="block appearance-none w-[10vw] h-[7vh] bg-white border border-[#99D2CB] hover:border-[#61b8ae] px-4 py-1 pr-8 rounded-full shadow leading-tight focus:outline-none focus:shadow-outline">
                ...
                <div className='mt-6 bg-white w-[44vw] h-full rounded-lg'>
                    ...
                    <div className="flex flex-col items-center justify-center w-full">
                        <label for="dropzone-file" className="flex flex-col items-center justify-center w-[43vw] mt-2 h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50  dark:bg-gray-700 hover:bg-[#dffcf838] dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                        ...
                        <div className='flex border border-[#cacaca] rounded-lg w-[43vw] h-[10vh] mt-2'>
                            <div className='bg-[#ff7f4d] flex flex-col justify-center  items-center w-[4vw]'>
