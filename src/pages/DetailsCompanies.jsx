...
<div className='bg-[#f7f7f7] h-screen w-full flex justify-center '>
   <div className='flex mt-10 flex-col'>
    <div className='flex gap-6 max-sm:flex-col max-sm:items-center'>
        <div className=''>
            <img className='h-[47vh] w-[25vw] rounded-lg object-cover max-sm:w-[88vw] max-sm:h-[45vh]' src={Elm} />
        </div>
        <div className=' bg-white w-[66vw] h-[47vh] rounded-lg max-sm:w-[88vw] max-sm:h-[45vh] '>
            ...
            <div className='flex justify-end items-center'>
                ...
                <div className="flex justify-end items-end mt-4 ml-6 pb-4 h-[13vh]">
                    <Link to="/Companies"><p className="w-[8vw] text-[#ffffff] font-bold text-[0.9rem] bg-[#7c7c7c] hover:bg-[#919191] py-2 px-4  rounded-lg cursor-pointer text-center max-sm:w-[20vw] max-sm:mb-5">العودة</p>
                    </Link>
                </div>
            </div>
        </div>      
